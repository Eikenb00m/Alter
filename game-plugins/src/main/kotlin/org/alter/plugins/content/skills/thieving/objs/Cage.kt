...
object CageRewards {
    ...
    val cage_steals = arrayOf(
        CageItem(Items.COINS_995, amount = 5, chance = 65.0),
        CageItem(Items.COINS_995, amount = 9, chance = 25.0),
        CageItem(Items.COINS_995, amount = 12, chance = 10.0),
        CageItem(Items.COINS_995, amount = 23, chance = 1.0)
    )
}